...
const startQuiz = () => {
  ...
  // Update the score header to show the user's name
  document.getElementById("score-header").innerHTML = `<span style="color:#FF6B00">${userName || "Your"}</span> Score: <span id="score">${score}</span>`;
